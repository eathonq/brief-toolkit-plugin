/**
 * DefaultI18nManager.ts — ILocalizedManager 的默认空实现（Null Object Pattern）
 * @description 在真实 LocalizedManager 绑定前提供安全的空操作，确保 ViewModel 中的
 *              I18n 调用永不因未绑定而崩溃。
...
export class DefaultI18nManager implements ILocalizedManager {
  ...
  on(_event: I18nEventType, _cb: (...args: any[]) => void, _target?: any): void {}

  off(_event: I18nEventType, _cb: (...args: any[]) => void, _target?: any): void {}
}
